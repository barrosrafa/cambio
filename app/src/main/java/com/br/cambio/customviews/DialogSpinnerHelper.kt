...
class DialogSpinnerHelper {
     ...
     * @param filterByCode booleano responsavel por fazer a pesquisa pelo pelo código.
     *
     * @return lista filtrada que atualizará o RecyclerView da DialogSpinner.
     */
    fun filterList(spinnerList: List<DialogSpinnerModel>,
                   charSequence: CharSequence?, filterByCode: Boolean = false): List<DialogSpinnerModel> {
