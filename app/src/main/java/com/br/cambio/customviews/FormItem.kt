...
interface FormItem {
    ...
    /**
     * Verifica se o campo em questão deverá ser scrollado para a parte inferior ou superior da
     * tela quando tiver foco, caso esteja sendo utilizado com um KeyboardNavigation.
     */
    fun shouldScrollToBottom() = fieldType != FIELD_TYPE_PASSWORD

    fun getDefaultSpacing(): Int {
        this as View
        return resources.getDimension(R.dimen.margin_keyboardnavigation)
            .toInt()
            .dpToPx(context)
    }
}